...
import guru.springfamework.repositories.VendorRespository;
...
public class VendorServiceImpl implements VendorService {
    ...
    public VendorServiceImpl(VendorMapper vendorMapper, VendorRespository vendorRepository) {
    ...
    public VendorListDTO getAllVendors() {
        ...
        return new VendorListDTO(vendorDTO);
    }
